...
<body>
			...
			<form method="post">
				<table style="position:relative; left:25%;">
					<tr>
						...
						<td><input type="email" name="email" value="<?php echo $fetch['email']; ?>" style="width:400px;"
								disabled></td>
					</tr>
					<tr>
					...
					<tr>
						<td></td>
						<td><button class="btn btn-info" name="send" style="width:300px;"><i
									class="icon icon-ok icon-white"></i>Submit</button>&nbsp;<a href="index.php"><button
									class="btn btn-danger" style="width:110px;"><i
										class="icon icon-remove icon-white"></i>Cancel</button></a></td>
					</tr>
				</table>
			</form>
		</div>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">B:Shoe Inc. 2023 Brought To You by <a
