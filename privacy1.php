...
<body>
	<div id="header">
		...
		<ul>
			...
			<li>Welcome:&nbsp;&nbsp;&nbsp;<a href="#profile" href data-toggle="modal"><i
	...
	<div id="container">
		...
		<div id="content">
			...
			<p>The B:Shoe Incorporated respect the privacy of the visitors
				to the B:Shoe.com website and the local websites connected with it, and take great care to
				protect your
			...
			<p>In order to protect the information you provide to us by visiting our website we have implemented various
				...
				confidential.Please keep in mind though that whenever you give out personal information online there is
				a
				risk that third parties may intercept and use that information. While B:Shoe strives to
				protect its user's
				personal information and privacy, we cannot guarantee the security of any information you disclose
				online
			...
			<p>You can turn off all cookies, in case you prefer not to receive them. You can also have your computer
				warn
	...
	<div>
		...
		<div id="footer">
			<div class="foot">
				...
				<p style="font-size:25px;">B:Shoe Inc. 2017 Brought To You by <a
						href="https://code-projects.org/">Code-Projects</a></p>
			</div>
			...
			<div id="foot">
				...
				<ul>
					...
					<a href="http://www.tumblr.com/OnlinesShoeStore">
						<li>Tumblr</li>
					</a>
				</ul>
			</div>
