...
<body>
		...
		<div id="carousel">
			<div id="myCarousel" class="carousel slide">
				<div class="carousel-inner">
					<div class="active item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner1.jpg"
							class="carousel"></div>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">B-Shoe 2023 </p>
		</div>

		<div id="foot">
			<h4>Links</h4>
			<ul>
				<a href="http://www.facebook.com/BStore">
					<li>Facebook</li>
				</a>
				<a href="http://www.twitter.com/BStore">
					<li>Twitter</li>
				</a>
				<a href="http://www.pinterest.com/BStore">
					<li>Pinterest</li>
				</a>
				<a href="http://www.tumblr.com/BStore">
					<li>Tumblr</li>
				</a>
			</ul>
		</div>
