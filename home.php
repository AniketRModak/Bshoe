...
<body>
	<div id="header">
		...
		<label style="font-family: cursive;">B:shoe</label>
			...
			<div id="carousel">
				<div id="myCarousel" class="carousel slide">
					<div class="carousel-inner">
						<div class="active item" style="padding:0; border-bottom:0 solid #111;"><img
								src="img/banner1.jpg" class="carousel"></div>
						<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner2.jpg"
								class="carousel"></div>
						<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner3.jpg"
								class="carousel"></div>
					</div>
			...
			<div id="product" style="position:relative; margin-top:30%;">
				...
				while ($fetch = $query->fetch_array()) {
					...
					if ($qty <= 5) {
						...
						echo "<h5>" . $fetch['product_name'] . "</h5>";
						echo "<span class='text-info'  text-indent:15px;'> Size: " . $fetch['product_size'] . "</h3>";
						echo "<h5> Rs " . $fetch['product_price'] . "</h5>";
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">B-shoe Inc. 2021</p>
		</div>
